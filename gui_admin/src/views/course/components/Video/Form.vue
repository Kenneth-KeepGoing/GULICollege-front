<template>
  ...
  <el-dialog :visible="dialogVisible" title="添加课时" @close="close()">
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button :disabled="saveOrUpdateBtnDisabled" type="primary" @click="saveOrUpdate()">确 定</el-button>
    </div>
  </el-dialog>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    submitUpload() {
      ...
      this.saveOrUpdateBtnDisabled = true
    ...
    handleUploadSuccess(response, file, fileList) {
      ...
      this.saveOrUpdateBtnDisabled = false
      if (response.success) {
        this.video.videoSourceId = response.data.videoId
        this.video.videoOriginalName = file.name
      } else {
        this.$message.error('上传失败(服务器失败)')
      }
    },
